package io.github.gomestdk.rest_with_spring_boot_and_java.exception.handler;

import io.github.gomestdk.rest_with_spring_boot_and_java.exception.*;
...
public class CustomEntityResponseHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> handleFileSaveExceptions(Exception ex, WebRequest request) {
        ExceptionResponse response = new ExceptionResponse(
                new Date(),
                ex.getMessage(),
                request.getDescription(false));
